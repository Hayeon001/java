...
public class Sql {
	...
	//Cart DML
	public static String cartDeleteSql = "DELETE FROM cart WHERE id = ?"; //장바구니 삭제
	public static String cartInsertSql = "INSERT INTO cart VALUES(?,?,?,?,SYSDATE)"; //id,user_id,item_id,cnt
	...
	public static String mycartcartSelectAllSql = "SELECT *FROM cart WHERE user_id = ?";
}
