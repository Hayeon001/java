...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println(e.getSalary());  //getter setter해줘야 가져올수 있음
		...
		Employee emps[] = new Employee[3]; //배열 사이즈 셋팅먼저
		emps[0] = new Employee("200","홍말자", 400);
		emps[1] = new Employee("201","장말자", 450);
		emps[2] = new Employee("202","정말자", 480);
